...
const TenGigabitSection = () => {
  ...
  return (
    <section id="10g-internet" className="py-8 relative overflow-hidden bg-gradient-to-br from-sky-50 via-blue-50 to-sky-100">
        ...
        <div className="bg-gradient-to-r from-sky-100 to-blue-100 rounded-2xl overflow-hidden relative border border-sky-200">
          ...
          <div className="relative z-10 p-8 md:p-12">
            <div className="text-center mb-12">
              <div className="inline-flex items-center bg-skynet-orange/20 backdrop-blur-sm text-skynet-blue text-lg font-medium px-6 py-3 rounded-full mb-6 border border-skynet-orange/30">
                <Zap className="h-6 w-6 mr-3 text-skynet-orange" />
                Революционная технология
              </div>
              
              <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold text-skynet-blue mb-6">
                Скайнет запускает интернет будущего!
              </h2>
              <h3 className="text-3xl md:text-4xl text-skynet-blue-dark mb-8">
                До 10 Гбит/с по технологии XGS-PON
              </h3>
              
              <div className="text-gray-700 mb-8">
                <p className="mb-6 text-2xl md:text-3xl font-semibold">Друзья, мы с гордостью объявляем о настоящем технологическом прорыве!</p>
            ...
            <div className="mb-12">
              <h3 className="text-3xl md:text-4xl font-bold text-skynet-blue mb-8 text-center">Что это значит для вас?</h3>
              <p className="text-gray-700 text-xl md:text-2xl text-center mb-8">
                Мы перевели технические термины на язык реальных преимуществ:
              </p>
              
              <div className="grid md:grid-cols-3 gap-8">
                <div className="bg-white/70 backdrop-blur-sm rounded-lg p-8 border border-skynet-orange/30 shadow-lg">
                  <div className="flex items-start mb-6">
                    <Zap className="h-10 w-10 text-skynet-orange mr-4 mt-1 flex-shrink-0" />
                    <div>
                      <h4 className="text-skynet-blue font-semibold mb-4 text-xl">Симметричная скорость</h4>
                ...
                <div className="bg-white/70 backdrop-blur-sm rounded-lg p-8 border border-skynet-orange/30 shadow-lg">
                  <div className="flex items-start mb-6">
                    ...
                    <div>
                      <h4 className="text-skynet-blue font-semibold mb-4 text-xl">Гейминг и развлечения без компромиссов</h4>
                      <p className="text-gray-700 text-lg">
                ...
                <div className="bg-white/70 backdrop-blur-sm rounded-lg p-8 border border-skynet-orange/30 shadow-lg">
                  <div className="flex items-start mb-6">
                    ...
                    <div>
                      <h4 className="text-skynet-blue font-semibold mb-4 text-xl">Надежность для всей семьи и бизнеса</h4>
                      <p className="text-gray-700 text-lg">
            ...
            <div className="bg-white/70 backdrop-blur-sm rounded-lg p-8 mb-8 border border-skynet-orange/30 shadow-lg">
              <h3 className="text-3xl md:text-4xl font-bold text-skynet-blue mb-6 text-center">Как это работает и как подключиться?</h3>
              
              <div className="space-y-6 mb-8">
                <p className="text-gray-700 text-xl">
                  <strong className="text-skynet-blue">XGS-PON</strong> — это следующее поколение оптоволоконных сетей (эволюция GPON). 
                ...
                <div className="bg-gradient-to-r from-skynet-orange/20 to-skynet-orange/30 rounded-lg p-6 border border-skynet-orange/40">
                  <p className="text-skynet-blue text-xl">
            ...
            <div className="text-center">
              ...
              <p className="text-skynet-blue font-semibold text-3xl mb-8">
              ...
              <div className="flex flex-wrap justify-center gap-4">
                ...
                <Link to="/tariffs" className="inline-flex items-center text-skynet-blue hover:text-skynet-blue-dark font-medium py-2 text-xl">
