...
const Hero = () => {
  return (
    <div className="relative min-h-screen pt-24 overflow-hidden bg-gradient-to-b from-white to-blue-50">
      ...
      <div className="absolute top-1/3 right-1/4 w-64 h-64 bg-skynet-orange/10 rounded-full blur-3xl animate-pulse-slow" />
      ...
      <div className="container mx-auto px-4 pt-10 pb-16 flex flex-col lg:flex-row items-center gap-12 relative z-10">
        ...
        <div className="flex-1 space-y-6 text-center lg:text-left max-w-2xl mx-auto lg:mx-0">
          <span className="inline-block px-3 py-1 rounded-full bg-skynet-orange/20 text-skynet-orange-bright text-sm font-medium animate-fade-in">
            Для частных лиц
          </span>
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight text-gray-900 animate-fade-in-up" style={{ animationDelay: '0.1s' }}>
            Интернет на скорости <span className="text-skynet-orange-bright">10 Гбит/с</span> для вашего дома
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start animate-fade-in-up" style={{ animationDelay: '0.3s' }}>
            <a 
              href="#pricing" 
              className="bg-skynet-orange hover:bg-skynet-orange-bright text-white rounded-full px-6 py-3 font-medium transition-all shadow-lg hover:shadow-xl transform hover:-translate-y-1 flex items-center justify-center sm:justify-start group"
            >
              Подключить сейчас
              <ArrowRight className="ml-2 h-5 w-5 transition-transform group-hover:translate-x-1" />
            </a>
            
            <a href="#speed-comparison" className="bg-white text-skynet-blue border border-skynet-blue rounded-full px-6 py-3 font-medium transition-all hover:bg-skynet-gray-light">
              Сравнить скорости
            </a>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-6 pt-6 justify-center lg:justify-start text-sm animate-fade-in-up" style={{ animationDelay: '0.4s' }}>
            <div className="flex items-center">
              <div className="bg-skynet-orange rounded-full w-2 h-2 mr-2"></div>
        ...
        <div className="flex-1 rounded-3xl overflow-hidden shadow-xl animate-fade-in-up" style={{ animationDelay: '0.5s' }}>
          <div className="relative bg-gradient-to-r from-skynet-blue-dark to-skynet-blue p-4 rounded-t-3xl">
            ...
            <div className="flex justify-between items-center mb-2">
              ...
              <div className="bg-skynet-orange/90 px-2 py-0.5 rounded text-white text-xs font-bold">Премиум</div>
            </div>
