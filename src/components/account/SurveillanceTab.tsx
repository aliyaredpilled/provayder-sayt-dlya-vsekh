...
const SurveillanceTab = ({ userData }: SurveillanceTabProps) => {
  ...
  return (
    <div>
      <div className="mb-6">
        <h1 className="text-xl lg:text-2xl font-bold text-gray-900 mb-4">Видеонаблюдение</h1>
        <button className="bg-skynet-blue hover:bg-skynet-blue-dark text-white px-4 py-2 rounded-lg transition-colors flex items-center justify-center gap-2 text-base">
        ...
        <div className="border-b border-gray-200">
          <nav className="flex">
            <button 
              ...
              className={`flex-1 lg:flex-none px-4 lg:px-6 py-4 font-medium text-base ${
                activeTab === 'private' 
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-4 lg:gap-6">
            {filteredCameras.map(camera => (
              <div key={camera.id} className="bg-white rounded-lg border border-gray-200 overflow-hidden shadow-sm">
                ...
                <div className="p-4">
                  <h3 className="font-medium text-gray-900 mb-2 text-base">{camera.name}</h3>
                  ...
                  <div className="flex flex-col sm:flex-row gap-2">
                    <button className="flex-1 bg-skynet-blue hover:bg-skynet-blue-dark text-white px-3 py-2 rounded text-base transition-colors">
                      Смотреть
                    </button>
                    <button className="flex-1 sm:flex-none border border-gray-300 text-gray-700 px-3 py-2 rounded hover:bg-gray-50 text-base transition-colors">
                      Настройки
                    </button>
                  </div>
                </div>
