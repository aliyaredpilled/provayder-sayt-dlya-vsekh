    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
        {isCompany ? (
            ...
            <div className="border-t border-gray-200 pt-6 mt-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <div className="mt-1 text-sm text-gray-900">ПАО "Сбербанк России"</div>
                </div>
                <div>
                ...
                <div>
                  ...
                  <div className="mt-1 text-sm text-gray-900">40702810123456789012</div>
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-700">Корреспондентский счет</label>
                  <div className="mt-1 text-sm text-gray-900">30101810123456789012</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-4">
            <h2 className="text-lg font-semibold text-gray-900 mb-4">Данные физического лица</h2>
            
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <label className="block text-sm font-medium text-gray-700">ФИО</label>
                <div className="mt-1 text-sm text-gray-900">{userData.personalData.fullName}</div>
              </div>
              <div>
                <label className="block text-sm font-medium text-gray-700">Телефон</label>
                <div className="mt-1 text-sm text-gray-900">{userData.personalData.phone}</div>
              </div>
              <div>
                <label className="block text-sm font-medium text-gray-700">E-Mail</label>
                <div className="mt-1 text-sm text-gray-900">{userData.personalData.email}</div>
              </div>
              <div className="md:col-span-2">
                <label className="block text-sm font-medium text-gray-700">Адрес</label>
                <div className="mt-1 text-sm text-gray-900">{userData.personalData.address}</div>
              </div>
            </div>
          </div>
        )}
