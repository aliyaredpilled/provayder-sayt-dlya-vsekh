                ...
                <div key={service.id} className="border border-gray-200 rounded-lg p-4">
                  <div className="flex justify-between items-start">
                    ...
                    <div className="text-right">
                      ...
                      <p className="text-base text-gray-500">ежемесячно</p>
                    </div>
                  </div>
                  
                  <div className="mt-6 border-t border-gray-100 pt-6 flex flex-wrap gap-3">
                    <button className="bg-skynet-blue hover:bg-skynet-blue-dark text-white px-4 py-2 rounded-lg transition-colors shadow-sm text-base">
                      Управление услугой
                    </button>
                    <button className="border border-gray-300 text-gray-700 px-4 py-2 rounded-lg hover:bg-gray-50 transition-colors text-base">
                      Сменить тариф
                    </button>
                    <button className="border border-red-300 text-red-600 px-4 py-2 rounded-lg hover:bg-red-50 transition-colors ml-auto text-base">
                      Отключить
                    </button>
                  </div>
                </div>
