...
// Обновленные отзывы с актуальными датами (в обратном порядке - новые сначала)
const reviews = [
  {
    id: 16,
    name: "Шамиль Халилов",
  ...
  },
  {
    ...
    date: "13 марта 2025",
    text: "Провели в дом интернет. О боги свершилось чудо теперь у меня дома есть стабильный, проводной инет. А не от мобильника, который вечно тормозил. Спасибо большое вам Скайнет-Стрим",
    rating: 5
  },
  {
    id: 10,
  ...
  return (
    <div className="bg-white rounded-xl shadow-md p-6 border border-gray-100 hover:shadow-lg transition-all">
      ...
      <div className="mt-4 text-right">
        <span className="text-xs text-gray-400">Клиент Скайнет-Стрим</span>
      </div>
    </div>
  );
};
        ...
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="text-lg text-gray-600 mb-12">
              По результатам опроса клиентов, вот что ценят пользователи Скайнет-Стрим больше всего
            </p>
          </div>
