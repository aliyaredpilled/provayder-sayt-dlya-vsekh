        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg text-gray-600">
              SKYNET — ведущий провайдер телекоммуникационных услуг в Казани и Республике Татарстан.
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-gray-600">
                Сегодня SKYNET — это команда из более чем 200 профессионалов, собственная оптоволоконная сеть протяженностью свыше 1000 км и современный дата-центр. Мы гордимся тем, что обеспечиваем высокоскоростной доступ в интернет для десятков тысяч семей и сотен предприятий.
              </p>
            </div>
