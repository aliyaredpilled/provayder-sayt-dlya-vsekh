...
const ConnectNeighborPromo = () => {
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="pt-20 pb-6 bg-gradient-to-b from-skynet-blue to-skynet-blue-light text-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <span className="inline-flex items-center bg-white/20 backdrop-blur-sm text-white text-sm font-medium px-3 py-1 rounded-full mb-4">
      ...
      <section className="py-6 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold text-gray-900 mb-6 text-center">Как работает акция</h2>
            ...
            <div className="bg-gray-50 rounded-2xl p-8 mb-8">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="flex items-start">
                  <CheckCircle2 className="h-5 w-5 text-skynet-blue mr-3 mt-1 flex-shrink-0" />
                  <div>
                    <h4 className="font-semibold text-gray-900 mb-2 text-base">Для действующих абонентов</h4>
                    <p className="text-gray-700 text-sm">Акция доступна всем текущим клиентам SKYNET без исключений</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  <CheckCircle2 className="h-5 w-5 text-skynet-blue mr-3 mt-1 flex-shrink-0" />
                  <div>
                    <h4 className="font-semibold text-gray-900 mb-2 text-base">Новый абонент</h4>
                    <p className="text-gray-700 text-sm">Сосед должен быть новым клиентом, ранее не пользовавшимся услугами SKYNET</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  <CheckCircle2 className="h-5 w-5 text-skynet-blue mr-3 mt-1 flex-shrink-0" />
                  <div>
                    <h4 className="font-semibold text-gray-900 mb-2 text-base">Территориальная близость</h4>
                    <p className="text-gray-700 text-sm">Новый абонент должен быть соседом из того же частного сектора</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  <CheckCircle2 className="h-5 w-5 text-skynet-blue mr-3 mt-1 flex-shrink-0" />
                  <div>
                    <h4 className="font-semibold text-gray-900 mb-2 text-base">Любой тариф</h4>
                    <p className="text-gray-700 text-sm">Акция действует при подключении к любому тарифному плану</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="text-center">
              ...
              <div className="flex justify-center">
                <Button className="bg-skynet-orange hover:bg-skynet-orange-bright text-white py-3 px-6 rounded-full shadow-lg hover:shadow-xl transition-all text-base">
