	...
	theme: {
		...
		extend: {
			...
			backgroundImage: {
				...
				'blue-purple-gradient': 'linear-gradient(135deg, #0A84FF, #9B87F5)',
				'blue-green-gradient': 'linear-gradient(135deg, #0A84FF, #34C759)',
			...
			boxShadow: {
				...
				'blue-glow': '0 0 20px rgba(10, 132, 255, 0.3)',
